...
for instance_idx, tid_dict in id_to_tids.items():
    ...
    with open(f"structured-framework/key_to_logits-box-acc-{instance_idx}.json") as f:
    ...
    for key, value in tid_dict.items(): 
        ...
        new_img_path = f"structured-framework/visuals/flickr30k-vilt-{key}-new_box_img_with_boxes.jpg"
        new_text = open(f"structured-framework/visuals/flickr30k-vilt-{key}-new_text.txt").read()
        random_img_path =  f"structured-framework/visuals/flickr30k-vilt-{key}-random_box_img.jpg"
