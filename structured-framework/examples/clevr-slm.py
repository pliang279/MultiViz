...
analyzepointandvisualizeallgrad(params,instance,analysismodel,predlabel,'visuals/tmp2/clevr-mdetr-sparse-223-','visuals/alls/clevr-mdetr-sparse-223-',pathnum=95,k=5)
analyzefeaturesandvisualizeallgrad(params, sampledata, analysismodel, predlabel, 'visuals/tmp2/clevr-mdetr-sparse-223-sampled-', 'visuals/alls/clevr-mdetr-sparse-223-sampled-',  prelinear=torch.load('plclevr.pt'), pathnum=95, k=5,pointsperfeat=3)
