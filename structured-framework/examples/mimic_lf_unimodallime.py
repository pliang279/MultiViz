...
explanation1 = rununimodallime(instance,'static','tabular',analysismodel,(predlabel,correctlabel),tabularbase = datas.allstatic(),feature_names = ['0','1','2','3','4'])
# generate lime explanation for timeseries modality on both correct label and predicted label
explanation2 = rununimodallime(instance,'timeseries','timeseriesC',analysismodel,(predlabel,correctlabel))
# visualize explanations and save to directory
visualizelime(explanation1,'tabular',predlabel,'visuals/mimic-lf-0-tabular-lime-pred.png')
visualizelime(explanation1,'tabular',correctlabel,'visuals/mimic-lf-0-tabular-lime-correct.png')
visualizelime(explanation2,'timeseriesC',predlabel,'visuals/mimic-lf-0-timeseries-lime-pred.png')
visualizelime(explanation2,'timeseriesC',correctlabel,'visuals/mimic-lf-0-timeseries-lime-correct.png')
