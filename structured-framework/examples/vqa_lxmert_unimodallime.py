...
visualizelime(explanation1,'image',predlabel,'visuals/vqa-lxmert-554-image-lime-pred.png')
visualizelime(explanation1,'image',correctlabel,'visuals/vqa-lxmert-554-image-lime-correct.png')
visualizelime(explanation2,'text',predlabel,'visuals/vqa-lxmert-554-text-lime-pred.png')
visualizelime(explanation2,'text',correctlabel,'visuals/vqa-lxmert-554-text-lime-correct.png')
