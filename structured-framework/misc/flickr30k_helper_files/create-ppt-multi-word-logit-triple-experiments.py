...
for instance_idx, tid_dict in id_to_tids.items():
    for key, value in tid_dict.items(): 
        ...
        new_img_path = f"structured-framework/visuals/flickr30k-vilt-{key}-new_img.jpg"
        new_text = open(f"structured-framework/visuals/flickr30k-vilt-{key}-new_text.txt").read()
        random_img_path =  f"structured-framework/visuals/flickr30k-vilt-{key}-random_img.jpg"
        gt_img_path = f"structured-framework/visuals/flickr30k-vilt-{key}-gt_img.jpg"
        ...
        dg_lgts = key_to_logits[str(instance_idx)][key]["doublegrad_logits"]
        rd_lgts = key_to_logits[str(instance_idx)][key]["random_drop_logits"]
