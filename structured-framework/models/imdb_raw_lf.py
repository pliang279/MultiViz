...
class IMDb_LF(analysismodel):
    ...
    def __init__(self, pretrained_model_path, multibench_path, google_vec_path, device='cuda:0', batch_size=32):
        ...
        self.googleword2vec = KeyedVectors.load_word2vec_format(google_vec_path, binary=True)
    ...
    def forwardbatch(self,datainstances):
        ...
        with torch.no_grad():
            for j in loader:
                ...
                text_features = ...
                image_features = ...
                model_inp = [text_features.to(self.device), image_features.to(self.device)]
